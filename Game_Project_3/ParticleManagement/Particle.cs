...
namespace Game_Project_3.ParticleManagement
{
    ...
    public struct Particle
    {
        ...
        /// </summary>
        public void Initialize(Vector2 where, float lifetime = 1, float scale = 1, float rotation = 0, float angularVelocity = 0, float angularAcceleration = 0, bool done = false)
        {
            this.Position = where;
