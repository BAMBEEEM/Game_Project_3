...
namespace Game_Project_3.ParticleManagement
{
    ...
    /// <summary>
    /// A class representing Outer Particle Effect for the tidal wave, Variation #1
    /// </summary>
    public class OuterWaveParticlesOne : ParticleSystem
    {
        Rectangle _source;
        ...
        public OuterWaveParticlesOne(Game game, Rectangle source) : base(game, 400)
        {
            _source = source;
